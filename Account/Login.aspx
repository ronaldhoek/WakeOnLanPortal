...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Vul je netwerkgebruikersnaam en wachtwoord in.
        <!--
        ...
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                <fieldset class="login">
                    <legend>Aanmeldingsinformaite</legend>
                    <p>
                    ...
                    <p>
                        ...
                        <asp:Label ID="RememberMeLabel" runat="server" AssociatedControlID="RememberMe" CssClass="inline">Houdt mij ingelogd</asp:Label>
                    </p>
                </fieldset>
                <p class="submitButton">
                    <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Aanmelden" ValidationGroup="LoginUserValidationGroup"/>
                </p>
            </div>
        </LayoutTemplate>
    </asp:Login>
